...
import dallEbg from "../Img/dallEbg.png";
import AOS from "aos";
            ...
            <div className="flex flex-row flex-wrap sm:flex-nowrap">
              <div className="flex-1 mr-0 sm:mr-2">
                <p>
                  ...
                  craft the funniest bits. It&apos;s like having a writing
                  partner who&apos;s always in a funny mood. Sign up to get
                  access!
                </p>
              </div>
          ...
          >
            ...
            <div className="flex flex-row flex-wrap-reverse sm:flex-nowrap">
              ...
              <div className="flex-1 ml-0 sm:ml-2">
                <p>
                  With Comedify, you can unleash your comedy genius by writing
                  and working on jokes and bits. Our platform provides a
                  creative space to refine your material and take your comedy to
                  the next level! Sign up to get access!
                </p>
              </div>
            </div>
          </div>
